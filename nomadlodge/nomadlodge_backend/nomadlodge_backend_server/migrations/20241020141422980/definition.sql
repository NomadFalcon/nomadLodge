...
-- Indexes
CREATE INDEX "booking_user_unique_idx" ON "booking" USING btree ("userId");
...
CREATE TABLE "integration" (
    ...
    "lastReloadDate" timestamp without time zone,
    "userId" bigint NOT NULL
);
...
CREATE INDEX "location_team_unique_idx" ON "location" USING btree ("teamId");
...
--
-- Class UserInvitation as table user_invitation
--
...
--
-- Foreign relations for "integration" table
--
...
--
-- Foreign relations for "user_invitation" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('nomadlodge_backend', '20241020141422980', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20241020141422980', "timestamp" = now();
