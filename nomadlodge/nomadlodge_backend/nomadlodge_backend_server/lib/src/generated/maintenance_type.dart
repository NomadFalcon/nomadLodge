...
class MaintenancetypeRepository {
  ...
  Future<List<Maintenancetype>> find(
    ...
    return databaseAccessor.db.find<Maintenancetype>(
  ...
  Future<Maintenancetype?> findFirstRow(
    ...
    return databaseAccessor.db.findFirstRow<Maintenancetype>(
      where: where?.call(Maintenancetype.t),
      orderBy: orderBy?.call(Maintenancetype.t),
      orderByList: orderByList?.call(Maintenancetype.t),
      orderDescending: orderDescending,
  ...
  Future<Maintenancetype?> findById(
    ...
    return databaseAccessor.db.findById<Maintenancetype>(
      id,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<Maintenancetype>> insert(
    ...
    return databaseAccessor.db.insert<Maintenancetype>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<Maintenancetype> insertRow(
    ...
    return databaseAccessor.db.insertRow<Maintenancetype>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<Maintenancetype>> update(
    ...
    return databaseAccessor.db.update<Maintenancetype>(
      rows,
  ...
  Future<Maintenancetype> updateRow(
    ...
    return databaseAccessor.db.updateRow<Maintenancetype>(
      row,
      columns: columns?.call(Maintenancetype.t),
      transaction: transaction ?? databaseAccessor.transaction,
    );
  ...
  Future<List<Maintenancetype>> delete(
    ...
    return databaseAccessor.db.delete<Maintenancetype>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<Maintenancetype> deleteRow(
    ...
    return databaseAccessor.db.deleteRow<Maintenancetype>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<Maintenancetype>> deleteWhere(
    ...
    return databaseAccessor.db.deleteWhere<Maintenancetype>(
  ...
  Future<int> count(
    ...
    return databaseAccessor.db.count<Maintenancetype>(
      where: where?.call(Maintenancetype.t),
      limit: limit,
      transaction: transaction ?? databaseAccessor.transaction,
    );
