...
class UserDeviceRepository {
  ...
  Future<List<UserDevice>> find(
    ...
    return databaseAccessor.db.find<UserDevice>(
  ...
  Future<UserDevice?> findFirstRow(
    ...
    return databaseAccessor.db.findFirstRow<UserDevice>(
      where: where?.call(UserDevice.t),
      orderBy: orderBy?.call(UserDevice.t),
      orderByList: orderByList?.call(UserDevice.t),
      orderDescending: orderDescending,
  ...
  Future<UserDevice?> findById(
    ...
    return databaseAccessor.db.findById<UserDevice>(
      id,
      transaction: transaction ?? databaseAccessor.transaction,
      include: include,
    );
  ...
  Future<List<UserDevice>> insert(
    ...
    return databaseAccessor.db.insert<UserDevice>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<UserDevice> insertRow(
    ...
    return databaseAccessor.db.insertRow<UserDevice>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<UserDevice>> update(
    ...
    return databaseAccessor.db.update<UserDevice>(
      rows,
  ...
  Future<UserDevice> updateRow(
    ...
    return databaseAccessor.db.updateRow<UserDevice>(
      row,
      columns: columns?.call(UserDevice.t),
      transaction: transaction ?? databaseAccessor.transaction,
    );
  ...
  Future<List<UserDevice>> delete(
    ...
    return databaseAccessor.db.delete<UserDevice>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<UserDevice> deleteRow(
    ...
    return databaseAccessor.db.deleteRow<UserDevice>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<UserDevice>> deleteWhere(
    ...
    return databaseAccessor.db.deleteWhere<UserDevice>(
  ...
  Future<int> count(
    ...
    return databaseAccessor.db.count<UserDevice>(
      where: where?.call(UserDevice.t),
      limit: limit,
      transaction: transaction ?? databaseAccessor.transaction,
    );
...
class UserDeviceAttachRowRepository {
  ...
  Future<void> user(
    ...
    await databaseAccessor.db.updateRow<UserDevice>(
      $userDevice,
