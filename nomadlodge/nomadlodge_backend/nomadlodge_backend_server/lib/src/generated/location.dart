...
abstract class Location implements _i1.TableRow, _i1.ProtocolSerialization {
  Location._({
    this.id,
    required this.name,
...
class LocationRepository {
  ...
  Future<List<Location>> find(
    ...
    return databaseAccessor.db.find<Location>(
  ...
  Future<Location?> findFirstRow(
    ...
    return databaseAccessor.db.findFirstRow<Location>(
      where: where?.call(Location.t),
      orderBy: orderBy?.call(Location.t),
      orderByList: orderByList?.call(Location.t),
      orderDescending: orderDescending,
  ...
  Future<Location?> findById(
    ...
    return databaseAccessor.db.findById<Location>(
      id,
      transaction: transaction ?? databaseAccessor.transaction,
      include: include,
    );
  ...
  Future<List<Location>> insert(
    ...
    return databaseAccessor.db.insert<Location>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<Location> insertRow(
    ...
    return databaseAccessor.db.insertRow<Location>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<Location>> update(
    ...
    return databaseAccessor.db.update<Location>(
      rows,
  ...
  Future<Location> updateRow(
    ...
    return databaseAccessor.db.updateRow<Location>(
      row,
      columns: columns?.call(Location.t),
      transaction: transaction ?? databaseAccessor.transaction,
    );
  ...
  Future<List<Location>> delete(
    ...
    return databaseAccessor.db.delete<Location>(
      rows,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<Location> deleteRow(
    ...
    return databaseAccessor.db.deleteRow<Location>(
      row,
      transaction: transaction ?? databaseAccessor.transaction,
    );
  }
  ...
  Future<List<Location>> deleteWhere(
    ...
    return databaseAccessor.db.deleteWhere<Location>(
  ...
  Future<int> count(
    ...
    return databaseAccessor.db.count<Location>(
      where: where?.call(Location.t),
      limit: limit,
      transaction: transaction ?? databaseAccessor.transaction,
    );
